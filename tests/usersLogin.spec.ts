...
import { UsersLoginRequest } from "../src/models/request/UsersLogin";
import { UserService } from "../src/services/userServices";
import { UserDao } from "../src/dao/usersDao";
import { CartDao } from "../src/dao/cartDao";
import { CartUser } from "../src/interfaces/cartInterfaces";
import { User } from "../src/interfaces/usersInterfaces";
...
describe("Users Login", () => {
  ...
  before(() => {
    ...
    stubValueUser = {
      ...
      avatar: faker.name.jobDescriptor(),
    };
    ...
    stub = sinon.stub(UserDao, "getCarrito").resolves(stubValueUser);
    stubCart = sinon.stub(CartDao, "getByIdUser").resolves(stubValueCart);
  });
